...
#include "hal_data.h"
iic_master_instance_ctrl_t g_touch_i2c_ctrl;
const iic_master_extended_cfg_t g_touch_i2c_extend =
{
...
const i2c_master_cfg_t g_touch_i2c_cfg =
{
    .channel             = 0,
...
#endif
    .ipl                 = (12),
    .p_extend            = &g_touch_i2c_extend,
};
/* Instance structure to use this module. */
const i2c_master_instance_t g_touch_i2c =
{
    .p_ctrl        = &g_touch_i2c_ctrl,
    .p_cfg         = &g_touch_i2c_cfg,
...
sci_b_uart_instance_ctrl_t     g_uart9_ctrl;
            ...
            {
                /* Baud rate calculated with 0.000% error. */ .baudrate_bits_b.abcse = 1, .baudrate_bits_b.abcs = 0, .baudrate_bits_b.bgdm = 0, .baudrate_bits_b.cks = 0, .baudrate_bits_b.brr = 9, .baudrate_bits_b.mddr = (uint8_t) 256, .baudrate_bits_b.brme = false
            };
