...
.rx_timestamp_storage = LAYER3_SWITCH_RX_TIMESTAMP_STORAGE_DISABLE,
            ...
            layer3_switch_descriptor_t           g_ether0_rx_descriptor_array0[95+1];layer3_switch_descriptor_t           g_ether0_rx_descriptor_array1[95+1];rmac_queue_info_t g_ether0_rx_queue_list[2] =
 {
{ .queue_cfg={.array_length       = 95+1,
