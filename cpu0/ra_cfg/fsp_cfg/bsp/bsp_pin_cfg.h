...
#define ESP_UART_TX (BSP_IO_PORT_04_PIN_00)
#define ESP_UART_RX (BSP_IO_PORT_04_PIN_01)
...
#define RGMII0_RX_CTL (BSP_IO_PORT_04_PIN_05) /* See J41 in manual */
#define RGMII0_RXD3 (BSP_IO_PORT_04_PIN_06) /* See J41 in manual */
...
#define ET0_INT (BSP_IO_PORT_05_PIN_13)
...
#define RGMII0_RXD2 (BSP_IO_PORT_07_PIN_00) /* See SW4 in manual */
#define RGMII0_RXD1 (BSP_IO_PORT_07_PIN_01) /* See SW4 in manual */
#define RGMII0_RXD0 (BSP_IO_PORT_07_PIN_02) /* See SW4 in manual */
#define RGMII0_RXC (BSP_IO_PORT_07_PIN_03) /* See SW4 in manual */
#define PMOD2_GPIO2 (BSP_IO_PORT_07_PIN_04) /* Enable when connected */
#define PARLCD_D18R2 (BSP_IO_PORT_07_PIN_07)
#define ET0_MDC (BSP_IO_PORT_07_PIN_08)
#define ET0_MDIO (BSP_IO_PORT_07_PIN_09)
#define ET0_LINKSTA (BSP_IO_PORT_07_PIN_10)
...
#define ETH_RST_N_PHY_RST_N (BSP_IO_PORT_07_PIN_14)
...
#define RGMII0_TXD0 (BSP_IO_PORT_11_PIN_00)
#define PARLCD_D13G5 (BSP_IO_PORT_11_PIN_01)
#define RGMII0_TXD1 (BSP_IO_PORT_11_PIN_02) /* See SW4 in manual */
#define RGMII0_TXD2 (BSP_IO_PORT_11_PIN_03) /* See SW4 in manual */
#define RGMII0_TXD3 (BSP_IO_PORT_11_PIN_04) /* See SW4 in manual */
...
#define ESP_WIFI_EN (BSP_IO_PORT_12_PIN_15)
...
extern const ioport_cfg_t g_bsp_pin_cfg; /* RA8P1_Competition_Board */
