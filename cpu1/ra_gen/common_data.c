...
/* MIPI PHY Macros */
        ...
        {
            .pll_settings = /* Calculated MIPI PHY PLL frequency: 614640000 Hz (error 0.04%) = (24000000 Hz / 3) * 153.66 / 2 */{.div      = 3 - 1,.pll_div  = 1, .mul_int  = 153 - 1,.mul_frac = 2 /* Value: 0.66 */},
            .lp_divisor   = 5 - 1,
...
mipi_dsi_instance_ctrl_t g_mipi_dsi0_ctrl;
        ...
        const mipi_dsi_cfg_t g_mipi_dsi0_cfg =
        {
            ...
            .vertical_back_porch      = (21 - 2),
            .vertical_front_porch     = (635 - 600 - 21 - 2),
            .vertical_sync_polarity   = (DISPLAY_SIGNAL_POLARITY_LOACTIVE != DISPLAY_SIGNAL_POLARITY_HIACTIVE),


            .horizontal_active_lines  = 1024,
            .horizontal_sync_lines    = 24,
            .horizontal_back_porch    = (136 - 24),
            .horizontal_front_porch   = (1344 - 1024 - 136 - 24),
            ...
            .hsa_no_lp                = ((R_MIPI_DSI_VMSET0R_HSANOLP_Msk | R_MIPI_DSI_VMSET0R_HBPNOLP_Msk | R_MIPI_DSI_VMSET0R_HFPNOLP_Msk |  0x0) & R_MIPI_DSI_VMSET0R_HSANOLP_Msk),
            .hbp_no_lp                = ((R_MIPI_DSI_VMSET0R_HSANOLP_Msk | R_MIPI_DSI_VMSET0R_HBPNOLP_Msk | R_MIPI_DSI_VMSET0R_HFPNOLP_Msk |  0x0) & R_MIPI_DSI_VMSET0R_HBPNOLP_Msk),
            .hfp_no_lp                = ((R_MIPI_DSI_VMSET0R_HSANOLP_Msk | R_MIPI_DSI_VMSET0R_HBPNOLP_Msk | R_MIPI_DSI_VMSET0R_HFPNOLP_Msk |  0x0) & R_MIPI_DSI_VMSET0R_HFPNOLP_Msk),

            .num_lanes                = 2,
            .ulps_wakeup_period       = 60,
            .continuous_clock         = (1),
