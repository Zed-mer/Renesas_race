...
const i2c_master_cfg_t g_touch_i2c_cfg = { .channel = 0, .rate =
		I2C_MASTER_RATE_STANDARD, .slave = 0x14, .addr_mode =
...
#endif
		.ipl = (12), .p_extend = &g_touch_i2c_extend, };
/* Instance structure to use this module. */
const i2c_master_instance_t g_touch_i2c = { .p_ctrl = &g_touch_i2c_ctrl,
		.p_cfg = &g_touch_i2c_cfg, .p_api = &g_i2c_master_on_iic };
