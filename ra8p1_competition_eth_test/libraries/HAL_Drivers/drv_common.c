...
void R_BSP_WarmStart (bsp_warm_start_event_t event)
{
    ...
    if (BSP_WARM_START_POST_C == event)
    {
        ...
        /* RA8P1 competition board Ethernet adapter enable: must be high before Ethernet init. */
        ...
        R_IOPORT_PinWrite(&IOPORT_CFG_CTRL, BSP_IO_PORT_07_PIN_14, BSP_IO_LEVEL_HIGH);
#endif
