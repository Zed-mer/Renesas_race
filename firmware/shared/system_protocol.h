...
#define RA8P1_SDR_TARGET_PAYLOAD_DEFAULT_MBPS_X1000 (500000UL)
...
#define RA8P1_MODEL_FLAG_V31_FOUR_MODEL_SCHEDULE (1UL << 14)
#define RA8P1_MODEL_FLAG_NO_STARTUP_BACKGROUND (1UL << 15)
#define RA8P1_MODEL_FLAG_V32_VIDEO_WIDTH       (1UL << 16)
#define RA8P1_MODEL_FLAG_V25_ACTIVITY_FUSION   (1UL << 17)
