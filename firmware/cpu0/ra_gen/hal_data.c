...
/* Baud rate calculated with 0.469% error. */.baudrate_bits_b.abcse = 0,
		...
		.baudrate_bits_b.cks = 0, .baudrate_bits_b.brr = 53,
...
const uart_cfg_t g_uart1_cfg = { .channel = 1, .data_bits = UART_DATA_BITS_8,
		.parity = UART_PARITY_OFF, .stop_bits = UART_STOP_BITS_1, .p_callback =
				user_uart1_callback, .p_context = NULL, .p_extend =
				&g_uart1_cfg_extend,
...
const uart_cfg_t g_uart8_cfg = { .channel = 8, .data_bits = UART_DATA_BITS_8,
		.parity = UART_PARITY_OFF, .stop_bits = UART_STOP_BITS_1, .p_callback =
				user_uart8_callback, .p_context = NULL, .p_extend =
				&g_uart8_cfg_extend,
#define RA_NOT_DEFINED (1)
#if (RA_NOT_DEFINED == RA_NOT_DEFINED)
		.p_transfer_tx = NULL,
...
.page_size_bytes = 64, .write_status_bit = 1, .write_enable_bit = 1,
    ...
    .xip_exit_command            = 0,
		...
		.erase_command_list_length = 1, .p_erase_command_list =
				(spi_flash_erase_command_t const*) g_hyper_ram_erase_commands,
...
static rmac_buffer_node_t g_ether0_buffer_node_list[257];
...
rmac_queue_info_t g_ether0_ts_queue[1] =
		{ { .queue_cfg = { .array_length = 8, .p_descriptor_array = NULL,
				.p_ts_descriptor_array = g_ether0_ts_descriptor_array0, .ports =
						(1 << 0), .type = LAYER3_SWITCH_QUEUE_TYPE_TX,
...
layer3_switch_descriptor_t g_ether0_tx_descriptor_array0[15 + 1];
layer3_switch_descriptor_t g_ether0_tx_descriptor_array1[15 + 1];
rmac_queue_info_t g_ether0_tx_queue_list[2] = { { .queue_cfg = { .array_length =
		15 + 1, .p_descriptor_array = g_ether0_tx_descriptor_array0,
		.p_ts_descriptor_array = NULL, .ports = (1 << 0), .type =
				LAYER3_SWITCH_QUEUE_TYPE_TX, .write_back_mode =
				LAYER3_SWITCH_WRITE_BACK_MODE_FULL, .descriptor_format =
				LAYER3_SWITCH_DISCRIPTOR_FORMTAT_EXTENDED,
		.rx_timestamp_storage = LAYER3_SWITCH_RX_TIMESTAMP_STORAGE_DISABLE, } },
		{ .queue_cfg = { .array_length = 15 + 1, .p_descriptor_array =
				g_ether0_tx_descriptor_array1, .p_ts_descriptor_array = NULL,
				.ports = (1 << 0), .type = LAYER3_SWITCH_QUEUE_TYPE_TX,
				.write_back_mode = LAYER3_SWITCH_WRITE_BACK_MODE_FULL,
				.descriptor_format = LAYER3_SWITCH_DISCRIPTOR_FORMTAT_EXTENDED,
				.rx_timestamp_storage =
						LAYER3_SWITCH_RX_TIMESTAMP_STORAGE_DISABLE, } }, };
layer3_switch_descriptor_t g_ether0_rx_descriptor_array0[95 + 1];
layer3_switch_descriptor_t g_ether0_rx_descriptor_array1[95 + 1];
rmac_queue_info_t g_ether0_rx_queue_list[2] = { { .queue_cfg = { .array_length =
		95 + 1, .p_descriptor_array = g_ether0_rx_descriptor_array0,
		.p_ts_descriptor_array = NULL, .ports = (1 << 0) | (0x0), .type =
				LAYER3_SWITCH_QUEUE_TYPE_RX, .write_back_mode =
				LAYER3_SWITCH_WRITE_BACK_MODE_FULL, .descriptor_format =
				LAYER3_SWITCH_DISCRIPTOR_FORMTAT_EXTENDED,
...
.rx_timestamp_storage = LAYER3_SWITCH_RX_TIMESTAMP_STORAGE_ENABLE,
		...
		.rx_timestamp_storage = LAYER3_SWITCH_RX_TIMESTAMP_STORAGE_DISABLE,
#endif
		} }, { .queue_cfg = { .array_length = 95 + 1, .p_descriptor_array =
		g_ether0_rx_descriptor_array1, .p_ts_descriptor_array = NULL, .ports =
		(1 << 0) | (0x0), .type = LAYER3_SWITCH_QUEUE_TYPE_RX,
		.write_back_mode = LAYER3_SWITCH_WRITE_BACK_MODE_FULL,
		.descriptor_format = LAYER3_SWITCH_DISCRIPTOR_FORMTAT_EXTENDED,
#if LAYER3_SWITCH_CFG_GPTP_ENABLE
.rx_timestamp_storage = LAYER3_SWITCH_RX_TIMESTAMP_STORAGE_ENABLE,
...
const rmac_extended_cfg_t g_ether0_extended_cfg_t = { .p_ether_switch =
		&g_layer3_switch0, .tx_queue_num = 2, .rx_queue_num = 2,

.p_ts_queue = g_ether0_ts_queue, .p_tx_queue_list = g_ether0_tx_queue_list,
...
#endif
		.rmpi_ipl = (BSP_IRQ_DISABLED), .p_buffer_node_list =
				g_ether0_buffer_node_list, .buffer_node_num = 257,
		.transmission_descriptor_format =
...
uint8_t g_ether0_ether_buffer128[1536];
uint8_t g_ether0_ether_buffer129[1536];
uint8_t g_ether0_ether_buffer130[1536];
uint8_t g_ether0_ether_buffer131[1536];
uint8_t g_ether0_ether_buffer132[1536];
uint8_t g_ether0_ether_buffer133[1536];
uint8_t g_ether0_ether_buffer134[1536];
uint8_t g_ether0_ether_buffer135[1536];
uint8_t g_ether0_ether_buffer136[1536];
uint8_t g_ether0_ether_buffer137[1536];
uint8_t g_ether0_ether_buffer138[1536];
uint8_t g_ether0_ether_buffer139[1536];
uint8_t g_ether0_ether_buffer140[1536];
uint8_t g_ether0_ether_buffer141[1536];
uint8_t g_ether0_ether_buffer142[1536];
uint8_t g_ether0_ether_buffer143[1536];
uint8_t g_ether0_ether_buffer144[1536];
uint8_t g_ether0_ether_buffer145[1536];
uint8_t g_ether0_ether_buffer146[1536];
uint8_t g_ether0_ether_buffer147[1536];
uint8_t g_ether0_ether_buffer148[1536];
uint8_t g_ether0_ether_buffer149[1536];
uint8_t g_ether0_ether_buffer150[1536];
uint8_t g_ether0_ether_buffer151[1536];
uint8_t g_ether0_ether_buffer152[1536];
uint8_t g_ether0_ether_buffer153[1536];
uint8_t g_ether0_ether_buffer154[1536];
uint8_t g_ether0_ether_buffer155[1536];
uint8_t g_ether0_ether_buffer156[1536];
uint8_t g_ether0_ether_buffer157[1536];
uint8_t g_ether0_ether_buffer158[1536];
uint8_t g_ether0_ether_buffer159[1536];
uint8_t g_ether0_ether_buffer160[1536];
uint8_t g_ether0_ether_buffer161[1536];
uint8_t g_ether0_ether_buffer162[1536];
uint8_t g_ether0_ether_buffer163[1536];
uint8_t g_ether0_ether_buffer164[1536];
uint8_t g_ether0_ether_buffer165[1536];
uint8_t g_ether0_ether_buffer166[1536];
uint8_t g_ether0_ether_buffer167[1536];
uint8_t g_ether0_ether_buffer168[1536];
uint8_t g_ether0_ether_buffer169[1536];
uint8_t g_ether0_ether_buffer170[1536];
uint8_t g_ether0_ether_buffer171[1536];
uint8_t g_ether0_ether_buffer172[1536];
uint8_t g_ether0_ether_buffer173[1536];
uint8_t g_ether0_ether_buffer174[1536];
uint8_t g_ether0_ether_buffer175[1536];
uint8_t g_ether0_ether_buffer176[1536];
uint8_t g_ether0_ether_buffer177[1536];
uint8_t g_ether0_ether_buffer178[1536];
uint8_t g_ether0_ether_buffer179[1536];
uint8_t g_ether0_ether_buffer180[1536];
uint8_t g_ether0_ether_buffer181[1536];
uint8_t g_ether0_ether_buffer182[1536];
uint8_t g_ether0_ether_buffer183[1536];
uint8_t g_ether0_ether_buffer184[1536];
uint8_t g_ether0_ether_buffer185[1536];
uint8_t g_ether0_ether_buffer186[1536];
uint8_t g_ether0_ether_buffer187[1536];
uint8_t g_ether0_ether_buffer188[1536];
uint8_t g_ether0_ether_buffer189[1536];
uint8_t g_ether0_ether_buffer190[1536];
uint8_t g_ether0_ether_buffer191[1536];

uint8_t *pp_g_ether0_ether_buffers[192] = {
		...
		(uint8_t*) &g_ether0_ether_buffer128[0],
		(uint8_t*) &g_ether0_ether_buffer129[0],
		(uint8_t*) &g_ether0_ether_buffer130[0],
		(uint8_t*) &g_ether0_ether_buffer131[0],
		(uint8_t*) &g_ether0_ether_buffer132[0],
		(uint8_t*) &g_ether0_ether_buffer133[0],
		(uint8_t*) &g_ether0_ether_buffer134[0],
		(uint8_t*) &g_ether0_ether_buffer135[0],
		(uint8_t*) &g_ether0_ether_buffer136[0],
		(uint8_t*) &g_ether0_ether_buffer137[0],
		(uint8_t*) &g_ether0_ether_buffer138[0],
		(uint8_t*) &g_ether0_ether_buffer139[0],
		(uint8_t*) &g_ether0_ether_buffer140[0],
		(uint8_t*) &g_ether0_ether_buffer141[0],
		(uint8_t*) &g_ether0_ether_buffer142[0],
		(uint8_t*) &g_ether0_ether_buffer143[0],
		(uint8_t*) &g_ether0_ether_buffer144[0],
		(uint8_t*) &g_ether0_ether_buffer145[0],
		(uint8_t*) &g_ether0_ether_buffer146[0],
		(uint8_t*) &g_ether0_ether_buffer147[0],
		(uint8_t*) &g_ether0_ether_buffer148[0],
		(uint8_t*) &g_ether0_ether_buffer149[0],
		(uint8_t*) &g_ether0_ether_buffer150[0],
		(uint8_t*) &g_ether0_ether_buffer151[0],
		(uint8_t*) &g_ether0_ether_buffer152[0],
		(uint8_t*) &g_ether0_ether_buffer153[0],
		(uint8_t*) &g_ether0_ether_buffer154[0],
		(uint8_t*) &g_ether0_ether_buffer155[0],
		(uint8_t*) &g_ether0_ether_buffer156[0],
		(uint8_t*) &g_ether0_ether_buffer157[0],
		(uint8_t*) &g_ether0_ether_buffer158[0],
		(uint8_t*) &g_ether0_ether_buffer159[0],
		(uint8_t*) &g_ether0_ether_buffer160[0],
		(uint8_t*) &g_ether0_ether_buffer161[0],
		(uint8_t*) &g_ether0_ether_buffer162[0],
		(uint8_t*) &g_ether0_ether_buffer163[0],
		(uint8_t*) &g_ether0_ether_buffer164[0],
		(uint8_t*) &g_ether0_ether_buffer165[0],
		(uint8_t*) &g_ether0_ether_buffer166[0],
		(uint8_t*) &g_ether0_ether_buffer167[0],
		(uint8_t*) &g_ether0_ether_buffer168[0],
		(uint8_t*) &g_ether0_ether_buffer169[0],
		(uint8_t*) &g_ether0_ether_buffer170[0],
		(uint8_t*) &g_ether0_ether_buffer171[0],
		(uint8_t*) &g_ether0_ether_buffer172[0],
		(uint8_t*) &g_ether0_ether_buffer173[0],
		(uint8_t*) &g_ether0_ether_buffer174[0],
		(uint8_t*) &g_ether0_ether_buffer175[0],
		(uint8_t*) &g_ether0_ether_buffer176[0],
		(uint8_t*) &g_ether0_ether_buffer177[0],
		(uint8_t*) &g_ether0_ether_buffer178[0],
		(uint8_t*) &g_ether0_ether_buffer179[0],
		(uint8_t*) &g_ether0_ether_buffer180[0],
		(uint8_t*) &g_ether0_ether_buffer181[0],
		(uint8_t*) &g_ether0_ether_buffer182[0],
		(uint8_t*) &g_ether0_ether_buffer183[0],
		(uint8_t*) &g_ether0_ether_buffer184[0],
		(uint8_t*) &g_ether0_ether_buffer185[0],
		(uint8_t*) &g_ether0_ether_buffer186[0],
		(uint8_t*) &g_ether0_ether_buffer187[0],
		(uint8_t*) &g_ether0_ether_buffer188[0],
		(uint8_t*) &g_ether0_ether_buffer189[0],
		(uint8_t*) &g_ether0_ether_buffer190[0],
		(uint8_t*) &g_ether0_ether_buffer191[0], };
const ether_cfg_t g_ether0_cfg = { .channel = 0, .zerocopy =
		...
		.promiscuous = ETHER_PROMISCUOUS_DISABLE, .flow_control =
				ETHER_FLOW_CONTROL_ENABLE, .padding = ETHER_PADDING_DISABLE,
		.padding_offset = 0, .broadcast_filter = 0, .p_mac_address =
				g_ether0_mac_address,

		.num_tx_descriptors = 64, .num_rx_descriptors = 192,
		...
		.p_callback = user_ether0_callback, .p_context = NULL, .p_extend =
				&g_ether0_extended_cfg_t, };

/* Instance structure to use this module. */
const ether_instance_t g_ether0 = { .p_ctrl = &g_ether0_ctrl, .p_cfg =
		&g_ether0_cfg, .p_api = &g_ether_on_rmac, };
