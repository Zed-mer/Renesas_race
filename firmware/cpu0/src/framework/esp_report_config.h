...
/*
 * Leave network credentials empty in source control. Configure these values
 * through a local, uncommitted board configuration before enabling STA mode.
 */
#define ESP_REPORT_WIFI_PRIMARY_SSID       ""
#define ESP_REPORT_WIFI_PRIMARY_PASSWORD   ""
