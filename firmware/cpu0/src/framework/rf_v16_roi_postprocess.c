...
#define RF_V16_INPUT_ZERO_POINT INT32_C(0)
...
static const int32_t rf_v16_channel_mean_q20[4] = {
    INT32_C(3800775), INT32_C(3228918), INT32_C(21), INT32_C(65)
};

static const int32_t rf_v16_channel_step_q20[4] = {
    INT32_C(641539), INT32_C(140220), INT32_C(146873), INT32_C(180931)
};
...
static int rf_v17_postprocess_candidate_internal(
    const int8_t *input_nhwc,
    size_t input_bytes,
    const rf_v16_candidate_t *candidate,
    const rf_v16_class_config_t *class_configs,
    ...
    int require_display_accept)
{
    ...
    if (subbin_configs == NULL ||
        (require_display_accept != 0 && result->display_accept == 0u)) {
        return 1;
    }
    if (class_configs == NULL) {
        class_configs = g_rf_v16_class_configs;
...
int rf_v17_postprocess_candidate(
    ...
    rf_v16_postprocess_result_t *result)
{
    return rf_v17_postprocess_candidate_internal(
        input_nhwc,
        input_bytes,
        candidate,
        class_configs,
