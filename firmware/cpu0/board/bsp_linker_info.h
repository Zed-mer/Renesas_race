...
#define BSP_PARTITION_FLASH_CPU0_S_SIZE (0x8E000)
#define BSP_PARTITION_FLASH_CPU0_C_START (0x02080000)
#define BSP_PARTITION_FLASH_CPU0_C_SIZE (0x0)
#define BSP_PARTITION_FLASH_CPU1_S_START (0x0208E000)
#define BSP_PARTITION_FLASH_CPU1_S_SIZE (0x72000)
...
#define BSP_PARTITION_SDRAM_CPU0_S_SIZE (0xB00000)
#define BSP_PARTITION_SDRAM_CPU1_S_START (0x68B00000)
#define BSP_PARTITION_SDRAM_CPU1_S_SIZE (0x500000)
