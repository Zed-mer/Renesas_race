...
volatile const char *g_codex_last_assert_expr;
volatile const char *g_codex_last_assert_func;
volatile rt_size_t g_codex_last_assert_line;
...
void rt_assert_handler(const char *ex_string, const char *func, rt_size_t line)
{
    ...
    g_codex_last_assert_expr = ex_string;
    g_codex_last_assert_func = func;
    g_codex_last_assert_line = line;
