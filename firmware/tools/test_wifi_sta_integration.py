...
class WifiStaIntegrationTests(unittest.TestCase):
    ...
    def test_source_controlled_wifi_credentials_are_empty(self) -> None:
        self.assertIn('#define ESP_REPORT_WIFI_PRIMARY_SSID       ""', CONFIG)
        self.assertIn('#define ESP_REPORT_WIFI_PRIMARY_PASSWORD   ""', CONFIG)
